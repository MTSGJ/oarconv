...
namespace UnityStandardAssets.Water
{
    ...
    public class Water : MonoBehaviour
    {
        ...
        //public float urpWaterAlpha = 0.35f;

        //bool urpAlphaInitialized = false;
        ...
        public void OnWillRenderObject()
        {
            ...
            if (UnityEngine.Rendering.GraphicsSettings.currentRenderPipeline != null)
            {
                ...
                if (r != null && r.sharedMaterial != null)
                {
                    ...
                    // URPではBRP水面の反射屈折レンダーはしないのでSimple固定
        ...
        void CreateWaterObjects(Camera currentCamera, out Camera reflectionCamera, out Camera refractionCamera)
        {
            ...
            if (mode >= WaterMode.Reflective)
            {
                ...
                if (!m_ReflectionTexture || m_OldReflectionTextureSize != textureSize)
                {
                    ...
                    m_ReflectionTexture.name = "__WaterReflection" + GetObjectIdString(this);
                ...
                {
                    GameObject go = new GameObject("Water Refl Camera id" + GetObjectIdString(this) + " for " + GetObjectIdString(currentCamera), 
            ...
            if (mode >= WaterMode.Refractive)
            {
                ...
                if (!m_RefractionTexture || m_OldRefractionTextureSize != textureSize)
                {
                    ...
                    m_RefractionTexture.name = "__WaterRefraction" + GetObjectIdString(this);
                ...
                {
                    GameObject go = new GameObject("Water Refr Camera id" + GetObjectIdString(this) + " for " + GetObjectIdString(currentCamera),
                                                   typeof(Camera), typeof(Skybox));
        ...
        private static string GetObjectIdString(UnityEngine.Object obj)
        {
