...
// ********** Begin Class UOAREditorSubsystem constinit property declarations **********************
// ********** End Class UOAREditorSubsystem constinit property declarations ************************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, UOAREditorSubsystem);
UOAREditorSubsystem::~UOAREditorSubsystem() {}
// ********** End Class UOAREditorSubsystem ********************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_MyProject8_Plugins_OARSelectMaterial_Source_OARSelectMaterial_Public_OAREditorSubsystem_h__Script_OARSelectMaterial_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UOAREditorSubsystem, UOAREditorSubsystem::StaticClass, TEXT("UOAREditorSubsystem"), &Z_Registration_Info_UClass_UOAREditorSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOAREditorSubsystem), 458922433U) },
	};
}; // Z_CompiledInDeferFile_FID_MyProject8_Plugins_OARSelectMaterial_Source_OARSelectMaterial_Public_OAREditorSubsystem_h__Script_OARSelectMaterial_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MyProject8_Plugins_OARSelectMaterial_Source_OARSelectMaterial_Public_OAREditorSubsystem_h__Script_OARSelectMaterial_990531864{
	TEXT("/Script/OARSelectMaterial"),
	Z_CompiledInDeferFile_FID_MyProject8_Plugins_OARSelectMaterial_Source_OARSelectMaterial_Public_OAREditorSubsystem_h__Script_OARSelectMaterial_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MyProject8_Plugins_OARSelectMaterial_Source_OARSelectMaterial_Public_OAREditorSubsystem_h__Script_OARSelectMaterial_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
